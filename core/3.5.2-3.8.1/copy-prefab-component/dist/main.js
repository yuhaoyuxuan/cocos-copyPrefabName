	...
	copyProperty.start = function (prefabPath) {
		...
		jsList.forEach((js, idx) => {
			...
			if (proName) {
				...
				} else if (proName.startsWith("spine")) {
					parseBuiltinComponent(proName, 'sp.Skeleton', js)
				} else if (proName.startsWith("ani")) {
					parseBuiltinComponent(proName, 'cc.Animation', js)
				} else if (proName.startsWith("opacity")) {
					parseBuiltinComponent(proName, 'cc.UIOpacity', js)
				} else if (proName.startsWith("mask")) {
					parseBuiltinComponent(proName, 'cc.Mask', js)
				} else if (proName.startsWith("audio")) {
					parseBuiltinComponent(proName, 'cc.AudioSource', js)
				} else if (proName.startsWith("particle")) {
					parseBuiltinComponent(proName, 'cc.ParticleSystem', js)
